...
<body>
    ...
    <div style="background-color: red;">
        ...
        <div style="background-color: aqua; width: 60px; margin:auto; text-align:center">2</div>

        <div style="display: flex; justify-content:space-between ; width:100%">
            <div style="background-color: blue; text-align:center ; width:100%"> 3 </div>
            <div style="background-color:chartreuse;  text-align:center ; width:100%    ">4</div>
        </div>
    ...
    <table style="border-collapse:collapse;  max-width:fit-content; border: 2px solid black; margin:  0 auto;">

        <tr style="border: 2px solid black;">
            <td style=" background-color:black; padding:20px"></td>
            <td style=" background-color:white; padding:20px"></td>
            <td style="background-color:black; padding:20px"></td>
            <td style="background-color:white; padding:20px"></td>
            <td style=" background-color:black; padding:20px"></td>
            <td style="background-color:white; padding:20px"></td>
    ...
    <table class="table1" style="border-collapse:collapse;  max-width:fit-content; border: 2px solid black; margin:  0 auto;">
