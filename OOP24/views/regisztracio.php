...
if (isset($_SESSION["flas"]["errors"]) && !empty($_SESSION["flas"]["errors"])){

 print "<div class='alert alert-danger'>";
 print "<ul>" ;


foreach($_SESSION["flas"]["errors"] as $error){
...
if (isset($_SESSION["flas"]["success"])){

print "<div class='alert alert-success'>";

print "{$_SESSION["flas"]["success"]}";
...
<h2 class="text-center mt-3">Regisztrációs űrlap</h2>
      ...
      <form action="/regisztracio" method="post" class="row gy-3" style="max-width: 900px;">
